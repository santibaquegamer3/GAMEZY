...
object DatabaseInstance {
            ...
            val instance = Room.databaseBuilder(
                ...
                .addCallback(object : RoomDatabase.Callback() {
                    override fun onCreate(db: androidx.sqlite.db.SupportSQLiteDatabase) {
                        ...
                        // Cuando se crea la base de datos por primera vez → insertar datos
                        CoroutineScope(Dispatchers.IO).launch {
                            preCargarDatos(context)
                        }
                    }
                })
                .build()
    ...
    private suspend fun preCargarDatos(context: Context) {
        val dao = getDatabase(context).videojuegoDao()
        ...
        listaInicial.forEach { dao.insertar(it) }
    }
}
